...
const questions = [
  "Hamari sabse funny memory kaunsi hai? 😄",
  "Hamari story ka sabse special moment tumhare liye kya hai? ❤️",
  "Meri kaunsi baat tumhein sabse zyada smile karwati hai? 😊",
  "Agar hamari story ka title hota, to kya hota? 💕",
  "Hamari koi aisi memory jo tum kabhi nahi bhoologi? 🌸",
  "Movie night 🎬 ya outing 🌸 — tum kya choose karogi?",
  "Surprise gift 🎁 ya surprise trip ✈️?",
  "Long conversation 💬 ya peaceful time together 🌙?",
  "Photos 📸 ya memories without photos? ❤️",
  "Cake 🎂 ya favourite food 🍕?",
  "Meri kaunsi habit tumhein secretly funny lagti hai? 😂",
  "Tumhare hisaab se meri dream surprise kya hogi? 🎁",
  ...
  "Complete this: Tum mere liye ______ ho. ❤️",
  ...
  "TRUTH 💭 — Hamari kaunsi memory tum dobara experience karna chahogi?",
  ...
  "MYSTERY 🔐 — Aaj tumhare birthday par tumhari ek wish kya hai? 🎂",
